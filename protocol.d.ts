...
/** A player left */
export type ServerPlayerLeft = [version: VERSION_TYPE, id: number];
...
export type ServerMessage = ServerPlayerLeft | ServerPlayerJoined | ServerGameSync | ServerGameStarted | ServerGameOver;
